...
const SECTION_NIVEL: MockInspectionSection = {
  id: "sec-nivel",
  code: "CALIBRACION_NIVEL",
  name: "Calibración y Verificación de Nivel",
  is_universal: false,
  fields: [
    { key: "tipo_instrumento",   label: "Tipo de instrumento",             type: "select",   required: true,  options: ["Diferencial de presión (DP)", "Radar (FMCW)", "Ultrasónico", "Flotador magnético", "Capacitivo", "Burbujeo", "Guía de onda (TDR)", "Electrónico de flotador"] },
    { key: "rango_min",          label: "Rango mínimo LRV",                type: "numero",   required: true,  validations: { unit: "mm" } },
    { key: "rango_max",          label: "Rango máximo URV",                type: "numero",   required: true,  validations: { unit: "mm" } },
    { key: "unidad_ing",         label: "Unidad de ingeniería",            type: "select",   required: true,  options: ["mm", "cm", "m", "%", "m³", "L"] },
    { key: "fluido",             label: "Fluido / material en proceso",    type: "texto",    required: false },
    { key: "tipo_proceso",       label: "Tipo de proceso",                 type: "select",   required: false, options: ["Líquido", "Sólido / polvo", "Interfase líquido-líquido", "Espuma"] },
    { key: "senal_salida",       label: "Señal de salida",                 type: "select",   required: true,  options: ["4-20 mA HART", "4-20 mA", "Fieldbus", "PROFIBUS PA", "Interruptor (switch)"] },
    { key: "posicion_montaje",   label: "Posición de montaje",             type: "select",   required: false, options: ["Lateral", "Superior (top)", "Externo (columna)", "Fondo"] },
    { key: "valvula_bloqueo",    label: "Válvulas de bloqueo/aislamiento", type: "checkbox", required: true,  options: ["OK", "FALLA", "N/A"] },
    { key: "purga_ok",           label: "Purgas / drenes operables",       type: "checkbox", required: false, options: ["OK", "FALLA", "N/A"] },
    { key: "fugas_ok",           label: "Sin fugas en conexiones",         type: "checkbox", required: true,  options: ["OK", "FALLA", "N/A"] },
    { key: "cal_0_aplicado",     label: "Nivel aplicado  0 % (LRV)",      type: "numero",   required: true,  validations: { unit: "mm" } },
    { key: "cal_0_leido_ma",     label: "Señal leída  0 % (mA)",          type: "numero",   required: true,  validations: { unit: "mA" } },
    { key: "cal_25_aplicado",    label: "Nivel aplicado 25 %",             type: "numero",   required: true,  validations: { unit: "mm" } },
    { key: "cal_25_leido_ma",    label: "Señal leída 25 % (mA)",          type: "numero",   required: true,  validations: { unit: "mA" } },
    { key: "cal_50_aplicado",    label: "Nivel aplicado 50 %",             type: "numero",   required: true,  validations: { unit: "mm" } },
    { key: "cal_50_leido_ma",    label: "Señal leída 50 % (mA)",          type: "numero",   required: true,  validations: { unit: "mA" } },
    { key: "cal_75_aplicado",    label: "Nivel aplicado 75 %",             type: "numero",   required: true,  validations: { unit: "mm" } },
    { key: "cal_75_leido_ma",    label: "Señal leída 75 % (mA)",          type: "numero",   required: true,  validations: { unit: "mA" } },
    { key: "cal_100_aplicado",   label: "Nivel aplicado 100 % (URV)",     type: "numero",   required: true,  validations: { unit: "mm" } },
    { key: "cal_100_leido_ma",   label: "Señal leída 100 % (mA)",         type: "numero",   required: true,  validations: { unit: "mA" } },
    { key: "ajuste_cero",        label: "Ajuste de cero realizado",        type: "checkbox", required: true,  options: ["SI", "NO", "N/A"] },
    { key: "ajuste_span",        label: "Ajuste de span realizado",        type: "checkbox", required: true,  options: ["SI", "NO", "N/A"] },
    { key: "error_max_pct",      label: "Error máximo admisible (%)",      type: "numero",   required: false, validations: { unit: "%", min: 0 } },
    { key: "foto_calibrador",    label: "Foto calibrador / evidencia",     type: "imagen",   required: false },
    { key: "obs_nivel",          label: "Observaciones",                   type: "textarea", required: false },
    { key: "resultado_nivel",    label: "Resultado",                       type: "select",   required: true,  options: ["APROBADO", "RECHAZADO"] },
  ],
};

const SECTION_ANALITICA: MockInspectionSection = {
  id: "sec-analitica",
  code: "CALIBRACION_ANALITICA",
  name: "Calibración y Verificación Analítica",
  is_universal: false,
  fields: [
    { key: "variable_medida",    label: "Variable medida",                 type: "select",   required: true,  options: ["pH", "ORP / Redox (mV)", "Conductividad (mS/cm)", "Turbidez (NTU)", "Oxígeno disuelto (mg/L)", "Cloro libre (mg/L)", "Cloro total (mg/L)", "Sólidos en suspensión (mg/L)", "CO₂ disuelto", "Amonio (mg/L)"] },
    { key: "tipo_sensor",        label: "Tipo de sensor / electrodo",      type: "texto",    required: true },
    { key: "rango_min",          label: "Rango mínimo LRV",                type: "numero",   required: true },
    { key: "rango_max",          label: "Rango máximo URV",                type: "numero",   required: true },
    { key: "unidad_ing",         label: "Unidad de ingeniería",            type: "select",   required: true,  options: ["pH", "mV", "mS/cm", "µS/cm", "NTU", "FTU", "mg/L", "ppm", "ppb", "%"] },
    { key: "senal_salida",       label: "Señal de salida",                 type: "select",   required: true,  options: ["4-20 mA HART", "4-20 mA", "Modbus RTU", "Profibus DP", "Profibus PA", "Fieldbus"] },
    { key: "fluido_proceso",     label: "Fluido / muestra en proceso",     type: "texto",    required: false },
    { key: "temperatura_proceso",label: "Temperatura proceso (°C)",        type: "numero",   required: false, validations: { unit: "°C" } },
    { key: "compensacion_temp",  label: "Compensación de temperatura",     type: "checkbox", required: false, options: ["Automática (NTC)", "Manual", "Sin compensación"] },
    { key: "limpieza_electrodo", label: "Limpieza electrodo realizada",    type: "checkbox", required: true,  options: ["SI", "NO", "N/A"] },
    { key: "solucion_cal_1",     label: "Solución patrón punto 1",         type: "texto",    required: true },
    { key: "cal_pto1_ref",       label: "Valor patrón punto 1",            type: "numero",   required: true },
    { key: "cal_pto1_leido",     label: "Lectura instrumento punto 1",     type: "numero",   required: true },
    { key: "solucion_cal_2",     label: "Solución patrón punto 2",         type: "texto",    required: true },
    { key: "cal_pto2_ref",       label: "Valor patrón punto 2",            type: "numero",   required: true },
    { key: "cal_pto2_leido",     label: "Lectura instrumento punto 2",     type: "numero",   required: true },
    { key: "solucion_cal_3",     label: "Solución patrón punto 3 (opt.)",  type: "texto",    required: false },
    { key: "cal_pto3_ref",       label: "Valor patrón punto 3",            type: "numero",   required: false },
    { key: "cal_pto3_leido",     label: "Lectura instrumento punto 3",     type: "numero",   required: false },
    { key: "senal_lrv_ma",       label: "Señal a LRV (mA)",               type: "numero",   required: false, validations: { unit: "mA" } },
    { key: "senal_urv_ma",       label: "Señal a URV (mA)",               type: "numero",   required: false, validations: { unit: "mA" } },
    { key: "pendiente_slope",    label: "Pendiente / slope (%)",           type: "numero",   required: false, validations: { unit: "%" } },
    { key: "ajuste_realizado",   label: "Ajuste de calibración realizado", type: "checkbox", required: true,  options: ["SI", "NO"] },
    { key: "foto_calibrador",    label: "Foto patrones / evidencia",       type: "imagen",   required: false },
    { key: "obs_analitica",      label: "Observaciones",                   type: "textarea", required: false },
    { key: "resultado_analitica",label: "Resultado",                       type: "select",   required: true,  options: ["APROBADO", "RECHAZADO"] },
  ],
};
...
export const MOCK_TEMPLATES: MockInspectionTemplate[] = [
  ...
  },
  {
    id: "tpl-ic-009",
    code: "P_IC_009",
    name: "Instrumento Analítico / Analizador",
    discipline: "I&C",
    sections: [
      SECTION_DATOS_GENERALES,
      SECTION_INSPECCION_VISUAL,
